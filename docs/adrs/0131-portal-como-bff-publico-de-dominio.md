...
- **A indisponibilidade das origens tem respostas distintas.** Ausência do registro do ato é transitória por construção e **degrada**: a linha do tempo vem vazia com aviso neutro, e essa resposta não é cacheada. Ausência do contrato de Seleção **não** degrada: o Portal não serve conteúdo vencido, porque a configuração publicada tem efeito jurídico e uma retificação não pode ser encoberta por cache; responde indisponibilidade temporária, sinalizando quando reencaminhar.
