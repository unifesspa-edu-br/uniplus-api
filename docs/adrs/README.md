...
> **Nota de numeração:** a `0077` (identidade de `Unidade`) foi **publicada** — a sequência de `0001` a `0097` está completa, sem lacunas. Ao adicionar uma ADR nova, use `0098+`.

## Como adicionar um novo ADR

1. Identifique o próximo número livre: **o maior número da tabela acima + 1** (atualmente `0097`). **Não** use `ls | wc -l` — confira a coluna de número da tabela e use o maior valor + 1.
