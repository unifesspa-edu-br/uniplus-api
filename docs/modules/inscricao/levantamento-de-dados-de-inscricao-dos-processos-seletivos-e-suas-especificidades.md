...
```COMO DEVE SER A CONFIRMAÇÃO DE INSCRICAO```
...
| 3 | Inscrição de Candidatos |<ul><li>```Formulários de Incrição```</li></ul>|
| 4 | Homologação das inscrições |<ul><li>Análise dos documentos obrigatórios enviados pelos candidatos.</li><li>Marcação de Deferido ou Indeferido, com o motivos do indeferimento, de acordo com os itens específicos do edital (apenas marcar nos itens obrigatórios, indicando a ausência), com campo de observação.</li><li>Geração de relação de candidatos deferidos e outra de indeferidos, com número de inscrição, nome do candidato, status (deferido ou indeferido) e motivo.</li></ul>|
...
| 7 | Homologação das inscrições | <ul><li>Processamento das notas, de acordo com as etapas, pesos e notas mínimas.<li>Classificação das pessoas candidatas de acordo com as modalidades, cotas, parâmetros de desempate e eliminação.</li><li>Geração de listas e relatórios para publicação.</li></ul>
|
...
|20| **Atendimento Especial?** |String |**Não Necessito<br>Prova Ampliada<br>Tempo Adicional ( Até 1 hora)<br>Prova em Braile<br>Intérprete de Língua de Sinais<br>Ledor<br>Lactante<br>Transcritor**||
|-----|-----------|------|--------|------------------|
|21| **Curso Pretendido (1ª Opção)** | String |[AZaz] ||
|22| **Curso Pretendido (2ª Opção)<br>```Apenas se o edital tiver previsão de SEGUNDA opção```** | String |[AZaz] ||
|23| **Lista de Espera (Deseja participar da segunda opção de curso? apenas um curso)** | String |**Não Participar da Lista de Espera<br>1ª Opção<br>2ª Opção(```Apenas se o edital tiver previsão de SEGUNDA opção```)** ||
...
|Campo| Descrição | Tipo | Valores| Texto Explicativo|
|-----|-----------|------|--------|------------------|
|24|**Sua nota do ENEM é referente ao ano de**|Inteiro|**[Anos Válidos]**|<div class="alert alert-warning small"><div class="mb-1"><i class="fa fa-exclamation-triangle fa-2x mr-2"></i><span class="font-weight-bold ">LEIA COM ATENÇÃO!</span></div><hr/><ul><li><p>Selecione o ano que você fez a prova do ENEM. Tenha atenção ao selecionar, pois você concorrerá com a nota correspondente ao ano selecionado.</p></li><li><p>Caso você informe o ano de referência do ENEM errado, inviabilizará o resgate de suas notas, resultando em sua eliminação no processo.</p></li></ul></div>|
|-----|**Perfil Social / Modalidades**|------|--------|----------------|
|25|**Deseja concorrer as vagas destinadas a PCD<br>(```se campo 09 NÃO CONTER "Sem deficiência"```)**|Bool |**[Sim / Não]**|Vagas previstas na Lei A Lei nº 13.146, de 6 de julho de 2015 e na Resolução Nº 532/2021 CONSEPE/Unifesspa|
|26|**Você estudou, durante todo o ensino médio, no Brasil, em escola pública ou em escola comunitária que atua no âmbito da educação do campo conveniada com o poder público?**|Bool |**[Sim / Não]**||
...
|28|**Você Deseja concorrer às vagas destinadas às pessoas candidatas autodeclaradas pretas, pardas ou indígenas?<br>(```se campo 08 = "Indígena OU Preta OU Parda"```)**|Bool |**[Sim / Não]**||
|29|**Você deseja concorrer às vagas reservadas às pessoas originárias de comunidades quilombolas??<br>(```se campo 17 = "Aldeia OU Comunidade OU Quilombo"```)**|Bool |**[Sim / Não]**||
|30|**Você e sua família possuem renda mensal bruta por pessoa (antes dos descontos) menor ou igual a um salário mínimo?**|Bool |**[Sim / Não]**||
|31|**Deseja concorrer às vagas reservadas às pessoas com renda mensal bruta por pessoa (antes dos descontos) menor ou igual a um salário mínimo?<br>(```se campo 30 = "Sim"```)**|Bool|**[Sim / Não]**||
|-----|**Especificidade PSVR**|------|--------|----------------|
|32|Sua renda individual (Renda Bruta)|Numérico|||
|33|Outro(s) membros (s) familiar (es)| String ||<table><thead><tr><th>ID</th><th>CPF</th><th>Grau de Parentesco</th><th>Nome</th><th>Renda Individual</th><th>Ações</th></tr></thead></table>|


<br>

## Seleção para Vagas de Programas Especiais (PSE) - Campos Especificos

<br>

|Campo| Descrição | Tipo | Valores| Texto Explicativo|
|-----|-----------|------|--------|------------------|
|24| **Curso (exceto PSE Indigena e Quilombola segunda opção)** | String |**[AZaz]**||
|25| **Modalidades** | String |**[AZaz]** ||
|26| **Anexos da Inscrição** | Blob |**[Arquivos]** |<div class="alert alert-info small"><i class="fa fa-comment  fa-2x"></i><span class="font-weight-bold m-2">ATENÇÃO!</span><p>Antes de inserir anexos, verifique se os mesmos estão em conformidade com as orientações-do edital do processo Clique no botão abaixo para acessar o edital ou a página do CEPS.</p><div class=" w-100 text-center"><a class="btn-sm btn btn-info" target="_blank" href="#"> Abrir Edital</a> / <a class="btn-sm btn btn-info" target="_blank" href="https://ceps.unifesspa.edu.br">Página do CEPS</a></div></div>|
|27| **Deseja optar pela utilização do bônus?** | Bool |**[Sim / Não]** |<div class="alert alert-warning small"><i class="fa fa-info-circle fa-2x mr-2"></i><span class="font-weight-bold">LEIA COM ATENÇÃO!</span><hr /><p>Os candidatos que optarem pela utilização do bônus deverão estar cientes e cumprir todas as regras para sua concessão, conforme determina o edital deste processo de seleção e deverão, obrigatoriamente, apresentar toda a documentação comprobatória para concessão do bônus.Os candidatos que solicitarem o bônus e não comprovarem o direito, no período da habilitação, serão eliminados sumariamente.</p>-</div>|
|28| **Autodenominação** | String |**Agricultores familiares<br>Extrativistas<br>Pescadores artesanais<br>Ribeirinhos<br>Assentados da Reforma Agrária<br>Quilombolas<br>Caiçaras<br>Indígenas<br>Quebradeiras de côco babaçu<br>Outros povos tradicionais<br>Acampados da Reforma Agrária<br>** ||


<br>

## Vestibular - Campos Especificos

<br>

|Campo| Descrição | Tipo | Valores| Texto Explicativo|
|-----|-----------|------|--------|------------------|
|24| **Modalidades** | String |**[AZaz]** |


<br>

## SISU - Campos Especificos

<br>

|Campo| Descrição | Tipo | Valores| Texto Explicativo|
|-----|-----------|------|--------|------------------|
|24| **Confirmação de Interesse** |String |**[AZaz]**|
|-----|**Perfil Social / Modalidades**|------|--------|----------------|
|25|**Deseja concorrer as vagas destinadas a PCD<br>(```se campo 09 NÃO CONTER "Sem deficiência"```)**|Bool |**[Sim / Não]**|Vagas previstas na Lei A Lei nº 13.146, de 6 de julho de 2015 e na Resolução Nº 532/2021 CONSEPE/Unifesspa|
|26|**Você estudou, durante todo o ensino médio, no Brasil, em escola pública ou em escola comunitária que atua no âmbito da educação do campo conveniada com o poder público?**|Bool |**[Sim / Não]**||
|27|**Você deseja concorrer às vagas destinadas às pessoas candidatas que cursaram todo o ensino médio, exclusivamente, em escolas públicas brasileiras da rede municipal, estadual ou federal ou em escolas comunitárias que atuam no âmbito da educação do campo conveniadas com o poder público?<br>(```se campo 26 = "Sim"```)**|Bool |**[Sim / Não]**||
...
|31|**Deseja concorrer às vagas reservadas às pessoas com renda mensal bruta por pessoa (antes dos descontos) menor ou igual a um salário mínimo?<br>(```se campo 30 = "Sim"```)**|Bool|**[Sim / Não]**||
|-----|-----------|------|--------|------------------|
|25|Sua renda individual (Renda Bruta)|Numérico|||
|26|Outro(s) membros (s) familiar (es)| String ||<table><thead><tr><th>ID</th><th>CPF</th><th>Grau de Parentesco</th><th>Nome</th><th>Renda Individual</th><th>Ações</th></tr></thead></table>|
|27|Total de pessoas em sua família|Numérico|||
|28|Renda mensal total da sua família|Numérico|||
|29|Renda mensal por pessoa|Numérico|```Campo Calculável```|Para concorrer a cotas por renda, você e sua família tem que receber, no máximo, um salário mínimo (R4 1.518,00) por pessoa.|


<br>

## Educação no Campo - Campos Especificos
...
|-----|-----------|------|--------|-------------------|
|24| **Confirmação de Interesse** | String |**[AZaz]**|
|25| **Modalidades** | String |**§ Ampla Concorrência<br>§ Pessoa Candidata com Deficiência (Resolução nº 64/2015 Consepe/Unifesspa)**|
|26| **Autodenominação** | String |**Agricultores familiares<br>Extrativistas<br>Pescadores artesanais<br>Ribeirinhos<br>Assentados da Reforma Agrária<br>Quilombolas<br>Caiçaras<br>Indígenas<br>Quebradeiras de côco babaçu<br>Outros povos tradicionais<br>Acampados da Reforma Agrária<br>** ||
|27| **Anexos da Inscrição** | Blob |**Arquivos**||

<br>

## Transferência Interna - Campos Especificos
...
## Transferência Externa - Campos Especificos
