# geo-dedicated-repository Specification

## Purpose
Formaliza a API Geo (localidades, endereçamento e georreferência) como serviço institucional transversal com repositório, ownership, CI e ciclo de release próprios — independentes do monólito modular Uni+ —, preservando o contrato HTTP público em V1 para os consumidores existentes (issue #732).
