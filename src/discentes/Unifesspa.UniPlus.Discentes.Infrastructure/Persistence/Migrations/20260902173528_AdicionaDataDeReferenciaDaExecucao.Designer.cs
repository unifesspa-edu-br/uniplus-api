...
namespace Unifesspa.UniPlus.Discentes.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260902173528_AdicionaDataDeReferenciaDaExecucao")]
    partial class AdicionaDataDeReferenciaDaExecucao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Unifesspa.UniPlus.Discentes.Infrastructure.Persistence.Records.VinculoDiscenteRecord", b =>
                {
                    ...
                    b.Property<string>("ResumoDoConteudo")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                        .HasColumnName("resumo_do_conteudo")
                        .HasComment("Resumo do conteúdo trazido do SIGAA na última sincronização — permite reconhecer que o vínculo não mudou e poupar a reescrita. Não cobre o CPF: como as demais colunas ficam legíveis, um resumo que o cobrisse permitiria recuperá-lo por tentativa e erro, desfazendo a cifra em repouso.");
