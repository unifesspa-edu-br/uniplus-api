...
/// <see cref="SnapshotPublicacaoCanonicalizer"/> é o encoder — "o canonicalizador de
/// hoje" — enquanto for também o corrente; no dia de um bump para 1.4, este codec
/// congela sua própria cópia do encoder, exatamente como <see cref="EnvelopeCodecV12"/>
/// fez para a 1.2.
/// </summary>
/// <remarks>
...
/// forma NÃO muda) e só acrescenta <c>LerMetadadosFatos</c>.
/// </remarks>
public sealed class EnvelopeCodecV13 : IEnvelopeCodec
{
    ...
    /// <summary>
    /// O encoder <c>1.3</c> é o canonicalizador de hoje — e enquanto ele for também o
    /// corrente, a delegação basta. Mesma guarda de <see cref="EnvelopeCodecV12"/> antes
    /// do bump para 1.3: se a emissão de produção mudar de versão sem este codec
    /// acompanhar, a guarda estoura em vez de deixar o round-trip das versões 1.3 já
    /// publicadas ficar não-verificável em silêncio (ADR-0110 D1, fitness test CA-08).
    /// </summary>
    ...
    /// <c>metadadosFatos</c> é a chave nova (RN08).
    /// </summary>
    private static (
