...
/// É o que a coluna gerada guarda, e o que a busca compara contra ela.
/// </summary>
/// <remarks>
...
/// inteiro: o que está fora da tabela passa intacto. É suficiente para o título do certame e o
/// número do edital, que é o alcance desta normalização.</para>
/// <para>A tabela é a mesma que a Configuração aplica às suas listagens, e a função vive no schema
/// de cada módulo porque os schemas não se atravessam. Duas tabelas com conteúdo diferente é que
/// seria o defeito — o mesmo texto precisa normalizar igual em qualquer listagem do sistema.</para>
/// </remarks>
internal static class NormalizacaoTextual
{
    ...
    internal const string FuncaoSql = "selecao.normalizar_para_comparacao";
