...
/// </summary>
/// <remarks>
/// Fica separado do catálogo de erros de domínio de propósito: o que se recusa aqui é a
/// <b>forma</b> do parâmetro — vírgulas seguidas, campo repetido —, coisa que nunca chega à
/// Application. Saber se o campo existe já é outra conversa, e essa acontece no handler, contra o
/// catálogo do recurso.
/// </remarks>
internal static class OrdenacaoMalFormadaExtensions
{
    internal static IActionResult ParaResposta(this SortExpressionError erro) =>
        new UnprocessableEntityObjectResult(new ProblemDetails
        {
            ...
            Type = "uniplus.selecao.consulta.ordenacao_mal_formada",
        });
}
