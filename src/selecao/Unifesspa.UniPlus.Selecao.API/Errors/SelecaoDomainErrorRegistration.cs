...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new("ConfiguracaoDistribuicaoVagas.GrupoAreaEnemEmBranco", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.grupo_area_enem_em_branco", "Grupo de área do ENEM da oferta em branco")),
