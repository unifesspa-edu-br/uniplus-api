...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new("ConfiguracaoBonusRegional.MunicipioConvenioTamanho", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_bonus_regional.municipio_convenio_tamanho", "Município do convênio excede o tamanho máximo permitido")),
        new("ConfiguracaoBonusRegional.BaseLegalTamanho", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_bonus_regional.base_legal_tamanho", "Base legal excede o tamanho máximo permitido")),
        ...
        new("ProcessoSeletivo.ConclusaoDeclaradaEmFaseQueSeConclui", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.conclusao_declarada_em_fase_que_se_conclui", "A fase publica preliminar e definitiva da própria matéria e não declara outra fase como concluinte")),
