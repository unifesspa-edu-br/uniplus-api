...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new("RegraRecursoFase.PrazoEmDiasUteisSemCalendario", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.regra_recurso_fase.prazo_em_dias_uteis_sem_calendario", "O prazo de interposição em dias úteis é recusado — não há calendário de dias úteis vigente")),
        new("RegraRecursoFase.SuspensividadeEmDiasUteisSemCalendario", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.regra_recurso_fase.suspensividade_em_dias_uteis_sem_calendario", "A suspensividade em dias úteis é recusada — não há calendário de dias úteis vigente")),
        // Issue #1113: calendário vigente existe, mas a unidade administradora do
        // processo não tem cidade cadastrada (snapshot congelado antes da issue #1114) —
        // sem localidade, feriados municipais não são resolvíveis.
        new("RegraRecursoFase.PrazoEmDiasUteisSemLocalidade", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.regra_recurso_fase.prazo_em_dias_uteis_sem_localidade", "O prazo de interposição em dias úteis é recusado — a unidade administradora não tem cidade cadastrada")),
        new("RegraRecursoFase.SuspensividadeEmDiasUteisSemLocalidade", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.regra_recurso_fase.suspensividade_em_dias_uteis_sem_localidade", "A suspensividade em dias úteis é recusada — a unidade administradora não tem cidade cadastrada")),
