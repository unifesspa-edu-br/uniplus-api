...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new("TipoEtapaSnapshot.CaractereNulo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.caractere_nulo", "Snapshot do tipo de etapa não pode conter o caractere nulo")),
        ...
        new("GrupoAreaEnemSnapshot.CaractereNulo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_area_enem_snapshot.caractere_nulo", "Grupo de área do ENEM contém caractere nulo")),
