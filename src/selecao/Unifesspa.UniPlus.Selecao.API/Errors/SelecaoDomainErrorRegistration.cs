...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new(MotivoDecisaoIsencaoErrorCodes.DescricaoCaractereInvalido, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.motivo_decisao_isencao.descricao_caractere_invalido", "Descrição do motivo contém caractere não permitido")),
        ...
        new("ProcessoSeletivo.CalendarioVigenteAusente", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.calendario_vigente_ausente", "Não há calendário de dias úteis vigente cadastrado")),
        new(DiaNaoUtilCongeladoErrorCodes.DataAusente, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.dia_nao_util_congelado.data_ausente", "A data do dia não útil congelado não pode ser o valor default")),
        new(DiaNaoUtilCongeladoErrorCodes.AbrangenciaInvalida, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.dia_nao_util_congelado.abrangencia_invalida", "Abrangência do dia não útil fora do vocabulário do calendário")),
        new(DiaNaoUtilCongeladoErrorCodes.MunicipioEmDiaEstadual, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.dia_nao_util_congelado.municipio_em_dia_estadual", "Dia de abrangência estadual não carrega município")),
        new(DiaNaoUtilCongeladoErrorCodes.UfAusenteEmDiaEstadual, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.dia_nao_util_congelado.uf_ausente_em_dia_estadual", "Dia de abrangência estadual exige a UF")),
        new(DiaNaoUtilCongeladoErrorCodes.UfInvalida, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.dia_nao_util_congelado.uf_invalida", "UF do dia não útil não é uma unidade federativa reconhecida")),
        new(DiaNaoUtilCongeladoErrorCodes.TerritorioEmDiaSemRecorte, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.dia_nao_util_congelado.territorio_em_dia_sem_recorte", "Dia sem recorte territorial não carrega município nem UF")),
        new(CalendarioDiasUteisCongeladoErrorCodes.OrigemObrigatoria, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.calendario_dias_uteis_congelado.origem_obrigatoria", "Identificador do calendário de origem é obrigatório")),
        new(CalendarioDiasUteisCongeladoErrorCodes.VersaoDatasetObrigatoria, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.calendario_dias_uteis_congelado.versao_dataset_obrigatoria", "Versão do dataset do calendário é obrigatória")),
        new(CalendarioDiasUteisCongeladoErrorCodes.VersaoDatasetTamanho, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.calendario_dias_uteis_congelado.versao_dataset_tamanho", "Versão do dataset do calendário excede o tamanho permitido")),
        new(CalendarioDiasUteisCongeladoErrorCodes.DiasObrigatorios, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.calendario_dias_uteis_congelado.dias_obrigatorios", "A lista de dias não úteis congelados é obrigatória")),
        new(CalendarioDiasUteisCongeladoErrorCodes.SemDiaNaoUtil, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.calendario_dias_uteis_congelado.sem_dia_nao_util", "O calendário congelado precisa ter ao menos um dia não útil")),
        new(CalendarioDiasUteisCongeladoErrorCodes.DiaDuplicado, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.calendario_dias_uteis_congelado.dia_duplicado", "O calendário congelado traz o mesmo dia não útil mais de uma vez")),
        new("TipoProcessoSnapshot.OrigemIdObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_processo_snapshot.origem_id_obrigatorio", "Origem do tipo de processo seletivo é obrigatória")),
        new("TipoProcessoSnapshot.CodigoObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_processo_snapshot.codigo_obrigatorio", "Código do tipo de processo seletivo é obrigatório")),
        new("TipoProcessoSnapshot.NomeObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_processo_snapshot.nome_obrigatorio", "Nome do tipo de processo seletivo é obrigatório")),
        new("TipoProcessoSnapshot.TamanhoInvalido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_processo_snapshot.tamanho_invalido", "Snapshot do tipo de processo seletivo excede o tamanho permitido")),
        new("TipoEtapaSnapshot.OrigemIdObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.origem_id_obrigatorio", "Origem do tipo de etapa é obrigatória")),
        new("TipoEtapaSnapshot.CodigoObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.codigo_obrigatorio", "Código do tipo de etapa é obrigatório")),
        new("TipoEtapaSnapshot.NomeObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.nome_obrigatorio", "Nome do tipo de etapa é obrigatório")),
        new("TipoEtapaSnapshot.SemCaraterAdmitido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.sem_carater_admitido", "Snapshot do tipo de etapa não admite caráter nenhum")),
        new("TipoEtapaSnapshot.NotaDeOrigemNoEnemSemPontuacao", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.nota_de_origem_no_enem_sem_pontuacao", "Snapshot do tipo de etapa com nota de origem no ENEM deve admitir compor a nota final")),
        new("TipoEtapaSnapshot.CaractereNulo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.caractere_nulo", "Snapshot do tipo de etapa contém caractere nulo ou que não é texto")),
        new("TipoEtapaSnapshot.TamanhoInvalido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.tipo_etapa_snapshot.tamanho_invalido", "Snapshot do tipo de etapa excede o tamanho permitido")),
        new("GrupoAreaEnemSnapshot.CodigoObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_area_enem_snapshot.codigo_obrigatorio", "Código do grupo de área do ENEM é obrigatório")),
        new("GrupoAreaEnemSnapshot.RotuloObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_area_enem_snapshot.rotulo_obrigatorio", "Rótulo do grupo de área do ENEM é obrigatório")),
        new("GrupoAreaEnemSnapshot.CaractereNulo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_area_enem_snapshot.caractere_nulo", "Grupo de área do ENEM contém caractere nulo ou que não é texto")),
        new("GrupoAreaEnemSnapshot.TamanhoInvalido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_area_enem_snapshot.tamanho_invalido", "Grupo de área do ENEM excede o tamanho permitido")),
        new("CalendarioVigente.FormaTerritorialInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.calendario_vigente.forma_territorial_invalida", "O calendário vigente traz dia com recorte territorial incoerente com a abrangência")),
        ...
        new("EtapaProcesso.NomeObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.nome_obrigatorio", "O nome da etapa é obrigatório")),
        new("EtapaProcesso.NomeTamanho", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.nome_tamanho", "O nome da etapa excede o tamanho máximo permitido")),
        new("EtapaProcesso.CaraterObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.carater_obrigatorio", "Caráter da etapa é obrigatório (classificatória, eliminatória ou ambas)")),
        new("EtapaProcesso.PesoInvalido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.peso_invalido", "O peso da etapa, quando informado, deve ser maior que zero")),
        new("EtapaProcesso.NotaMinimaInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.nota_minima_invalida", "A nota mínima, quando informada, não pode ser negativa")),
        new("EtapaProcesso.OrdemInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.ordem_invalida", "A ordem da etapa, quando informada, deve ser maior que zero")),
        new("EtapaProcesso.PesoSemCaraterQuePontua", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.peso_sem_carater_que_pontua", "Peso só se aplica a etapa cujo caráter compõe a nota final")),
        new("EtapaProcesso.NotaMinimaSemCaraterQueElimina", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.nota_minima_sem_carater_que_elimina", "Nota mínima só se aplica a etapa cujo caráter elimina")),
        new("EtapaProcesso.CaraterNaoAdmitidoPeloTipo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.carater_nao_admitido_pelo_tipo", "O tipo de etapa não admite o caráter declarado")),
        ...
        new("ProcessoSeletivo.EtapaNotaEnemDuplicada", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_nota_enem_duplicada", "O processo admite uma única etapa de nota do ENEM")),
        new("ProcessoSeletivo.EtapaNotaEnemNaoCompoeNota", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_nota_enem_nao_compoe_nota", "Etapa de nota do ENEM deve compor a média, com caráter classificatória ou ambas e peso")),
        new("ProcessoSeletivo.EtapaNotaEnemComBanca", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_nota_enem_com_banca", "Etapa de nota do ENEM não admite banca")),
        new("ProcessoSeletivo.EtapaNotaEnemComProdutoOuRecursoEmAto", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_nota_enem_com_produto_ou_recurso_em_ato", "Etapa de nota do ENEM não declara produto nem recurso ancorado em ato; o recurso coletivo é o da regra de recurso da fase")),
        new("ProcessoSeletivo.EtapaNotaEnemSemClassificacaoEnem", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_nota_enem_sem_classificacao_enem", "Etapa de nota do ENEM exige classificação baseada em ENEM pela média ponderada")),
        ...
        // Identificador legível do certame (issue #1479): forma, obrigatoriedade na geração de
        // versão, definição só antes da primeira publicação e unicidade entre processos.
        new(ProcessoSeletivoErrorCodes.IdentificadorLegivelTamanho, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.identificador_legivel_tamanho", "O identificador legível deve ter entre 3 e 64 caracteres")),
        new(ProcessoSeletivoErrorCodes.IdentificadorLegivelFormatoInvalido, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.identificador_legivel_formato_invalido", "O identificador legível deve estar em kebab-case")),
        ...
        new(ProcessoSeletivoErrorCodes.IdentificadorLegivelAusente, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.identificador_legivel_ausente", "O identificador legível é obrigatório para gerar versão publicada")),
        new(ProcessoSeletivoErrorCodes.IdentificadorLegivelImutavel, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.identificador_legivel_imutavel", "O identificador legível só é definido pelo cadastro antes da primeira publicação")),
        ...
        new("ProcessoSeletivo.FormularioTituloTamanho", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.formulario_titulo_tamanho", "Título do formulário de inscrição excede o tamanho máximo")),
        new("ProcessoSeletivo.FormularioTermoAceiteTextoTamanho", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.formulario_termo_aceite_texto_tamanho", "Termo de aceite do formulário de inscrição excede o tamanho máximo")),
        ...
        new("ConfiguracaoDistribuicaoVagas.ParCruzadoNaoReciproco", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.par_cruzado_nao_reciproco", "Par de remanejamento cruzado não aponta de volta")),
        new("ConfiguracaoDistribuicaoVagas.ReclassificacaoParaAmplaSemAmplaOfertada", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.reclassificacao_para_ampla_sem_ampla_ofertada", "Modalidade reclassifica na ampla concorrência, que não está ofertada")),
        new("ConfiguracaoDistribuicaoVagas.MotorDeAjusteVedadoNaLei12711", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.motor_de_ajuste_vedado_na_lei_12711", "Motor de redução não se aplica à distribuição pela Lei 12.711")),
        new("ConfiguracaoDistribuicaoVagas.AjusteNaoAbsorveOExcesso", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.ajuste_nao_absorve_o_excesso", "Modalidades do ajuste não comportam o excesso do quadro")),
        new("ConfiguracaoDistribuicaoVagas.AjusteReferenciaModalidadeForaDoQuadro", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.ajuste_referencia_modalidade_fora_do_quadro", "Ajuste reduz de modalidade fora das selecionadas")),
        new("ConfiguracaoDistribuicaoVagas.ModalidadeNaoAdmitidaPelaRegra", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.modalidade_nao_admitida_pela_regra", "Modalidade fora do rol que a regra de distribuição admite")),
        new("ConfiguracaoDistribuicaoVagas.ModalidadeDoRolAusente", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.modalidade_do_rol_ausente", "Falta modalidade do rol fechado que a regra de distribuição exige")),
        new("ConfiguracaoDistribuicaoVagas.VoBaseAcimaDasVagasAutorizadas", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.vo_base_acima_das_vagas_autorizadas", "VO_base acima das vagas anuais autorizadas da oferta")),
        new("ConfiguracaoDistribuicaoVagas.QuadroExcedeVoBase", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.quadro_excede_vo_base", "Quadro de vagas acima do total da oferta")),
        new("ConfiguracaoDistribuicaoVagas.QuadroNaoCompletaVoBase", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_distribuicao_vagas.quadro_nao_completa_vo_base", "Quadro de vagas abaixo do total da oferta")),
        ...
        new("ModalidadeSelecionada.ModalidadeOrigemIdObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.modalidade_selecionada.modalidade_origem_id_obrigatorio", "Identidade da modalidade de origem é obrigatória")),
        ...
        new("ModalidadeSelecionada.RemanejamentoCruzadoIncompleto", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.modalidade_selecionada.remanejamento_cruzado_incompleto", "Modalidade com remanejamento CRUZADO exige o par")),
        ...
        // Desempate por área do ENEM: a forma da ordem de áreas e a coerência dela com o
        // quadro de pesos por área congelado na classificação.
        new(DesempatePorAreaEnemErrorCodes.AreasObrigatorias, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.criterio_desempate.areas_obrigatorias", "O critério de desempate por área do ENEM exige ao menos uma área")),
        new(DesempatePorAreaEnemErrorCodes.AreasEmExcesso, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.criterio_desempate.areas_em_excesso", "A ordem de desempate por área do ENEM tem áreas demais")),
        new(DesempatePorAreaEnemErrorCodes.AreaInvalida, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.criterio_desempate.area_invalida", "Código de área do ENEM inválido na ordem de desempate")),
        new(DesempatePorAreaEnemErrorCodes.AreaRepetida, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.criterio_desempate.area_repetida", "A mesma área do ENEM aparece mais de uma vez na ordem de desempate")),
        new(ProcessoSeletivoErrorCodes.CriteriosDesempateEmExcesso, new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.criterios_desempate_em_excesso", "A ordem de desempate tem critérios demais")),
        ...
        new("ConfiguracaoBonusRegional.CamposObrigatorios", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_bonus_regional.campos_obrigatorios", "RegraVersao, Fator e BaseLegalBonusRegionalId são obrigatórios quando RegraCodigo é informado")),
        ...
        new("ConfiguracaoBonusRegional.BaseLegalNaoEncontrada", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_bonus_regional.base_legal_nao_encontrada", "Base legal de bônus regional não encontrada ou desativada")),
        new("ConfiguracaoBonusRegional.SemMunicipios", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_bonus_regional.sem_municipios", "A base legal do bônus regional deve abranger pelo menos um município")),
        // Cascata de remanejamento (Story #575, RN-CASCATA-1..5) — a outra metade da flag
        // SegueCascata de ModalidadeSelecionada, que hoje aponta para o nada.
        new("ConfiguracaoCascataRemanejamento.CamposObrigatorios", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.campos_obrigatorios", "RegraCodigo, RegraVersao, FallbackCodigo e Destinos precisam estar todos presentes ou todos ausentes")),
        new("ConfiguracaoCascataRemanejamento.RegraNaoEncontrada", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.regra_nao_encontrada", "Regra de remanejamento não encontrada no rol_de_regras")),
        new("ConfiguracaoCascataRemanejamento.RegraTipoInvalido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.regra_tipo_invalido", "A regra referenciada não é do tipo criterio_remanejamento")),
        new("ConfiguracaoCascataRemanejamento.MatrizDivergenteDaRegra", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.matriz_divergente_da_regra", "A cascata informada diverge do esquema_args da regra referenciada")),
        new("ConfiguracaoCascataRemanejamento.FallbackObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.fallback_obrigatorio", "O código de fallback é obrigatório e precisa casar com o vocabulário de modalidade")),
        new("ConfiguracaoCascataRemanejamento.SemDestinos", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.sem_destinos", "A cascata precisa de ao menos um destino")),
        new("ConfiguracaoCascataRemanejamento.ExcedeLimiteDeOrigens", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.excede_limite_de_origens", "A cascata excede o limite de 8 origens")),
        new("ConfiguracaoCascataRemanejamento.ExcedeLimiteDeDestinos", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.excede_limite_de_destinos", "A cascata excede o limite de 56 destinos")),
        new("ConfiguracaoCascataRemanejamento.CodigoInvalido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.codigo_invalido", "Código de modalidade fora do vocabulário ^[A-Z0-9_]+$ ou acima de 60 caracteres")),
        new("ConfiguracaoCascataRemanejamento.OrdemDuplicadaNaOrigem", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.ordem_duplicada_na_origem", "A mesma origem tem mais de um destino na mesma posição de ordem")),
        new("ConfiguracaoCascataRemanejamento.OrdemInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.ordem_invalida", "A ordem do destino deve ser ≥ 1")),
        new("ConfiguracaoCascataRemanejamento.OrdemNaoContigua", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.ordem_nao_contigua", "A sequência de ordens de uma origem não é contígua a partir de 1")),
        new("ConfiguracaoCascataRemanejamento.DestinoDuplicado", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.destino_duplicado", "A mesma origem repete o mesmo destino mais de uma vez")),
        new("ConfiguracaoCascataRemanejamento.OrigemIgualAoDestino", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_cascata_remanejamento.origem_igual_ao_destino", "Uma modalidade não pode remanejar para si mesma")),
        new("ProcessoSeletivo.CascataOrigemAusente", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.cascata_origem_ausente", "Uma modalidade SegueCascata não tem sequência de destinos declarada na cascata do processo")),
        new("ProcessoSeletivo.CascataFallbackNaoSelecionadoNaOferta", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.cascata_fallback_nao_selecionado_na_oferta", "O fallback (ou o destino resolvível) da cascata não é modalidade selecionada na oferta")),
        ...
        new("ProcessoSeletivo.CascataForaDoRegimeFederal", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.cascata_fora_do_regime_federal", "Uma modalidade SegueCascata está numa oferta que não usa regra de distribuição do ramo federal (Lei 12.711)")),
        ...
        new("ConfiguracaoClassificacao.FaltaEmDiaDeProvaEnemRepetida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.falta_em_dia_de_prova_enem_repetida", "A eliminação por falta em dia de prova do ENEM só pode ser declarada uma vez")),
        new("ConfiguracaoClassificacao.CorteEmAreaRepetido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.corte_em_area_repetido", "A mesma área tem mais de um corte")),
        new("ConfiguracaoClassificacao.CorteEmAreaForaDoQuadro", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.corte_em_area_fora_do_quadro", "A área do corte não está em todos os grupos do quadro de pesos por área")),
        new("ConfiguracaoClassificacao.ArredondamentoObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.arredondamento_obrigatorio", "Cálculo local exige regra de arredondamento")),
        new("ConfiguracaoClassificacao.CasasArredondamentoObrigatorio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.casas_arredondamento_obrigatorio", "Cálculo local exige casas decimais de arredondamento maior que zero")),
        ...
        // Resolução de Pesos por Área declarada e congelada na classificação baseada em ENEM.
        new("ConfiguracaoClassificacao.ResolucaoPesoAreaEnemObrigatoria", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.resolucao_peso_area_enem_obrigatoria", "A classificação baseada em ENEM com cálculo local exige a resolução de Pesos por Área")),
        new("ConfiguracaoClassificacao.ResolucaoPesoAreaEnemIndevida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.resolucao_peso_area_enem_indevida", "A resolução de Pesos por Área só se aplica à classificação baseada em ENEM com cálculo local")),
        new("ConfiguracaoClassificacao.ResolucaoPesoAreaEnemInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.resolucao_peso_area_enem_invalida", "A resolução de Pesos por Área excede o tamanho permitido ou contém caractere de controle, de formatação ou de quebra de linha")),
        new("ConfiguracaoClassificacao.ResolucaoPesoAreaEnemNaoEncontrada", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.resolucao_peso_area_enem_nao_encontrada", "A resolução de Pesos por Área informada não tem pesos cadastrados")),
        new("ConfiguracaoClassificacao.ResolucaoPesoAreaEnemIncompleta", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.resolucao_peso_area_enem_incompleta", "A resolução de Pesos por Área não tem pesos para todos os grupos de área")),
        new("ConfiguracaoClassificacao.QuadroPesoAreaEnemVazio", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.quadro_peso_area_enem_vazio", "A resolução de Pesos por Área declarada não tem nenhum grupo de área congelado")),
        new("ConfiguracaoClassificacao.QuadroPesoAreaEnemGrupoRepetido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.configuracao_classificacao.quadro_peso_area_enem_grupo_repetido", "O quadro de pesos por área repete um grupo de área")),
        new("GrupoPesoAreaEnemCongelado.BaseLegalObrigatoria", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_peso_area_enem_congelado.base_legal_obrigatoria", "A base legal do grupo no quadro de pesos por área é obrigatória")),
        new("GrupoPesoAreaEnemCongelado.BaseLegalInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_peso_area_enem_congelado.base_legal_invalida", "A base legal do grupo no quadro de pesos por área excede o tamanho permitido ou contém o caractere nulo ou caractere que não é texto")),
        new("GrupoPesoAreaEnemCongelado.AreaInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_peso_area_enem_congelado.area_invalida", "Área do quadro de pesos por área sem código ou rótulo válido")),
        new("GrupoPesoAreaEnemCongelado.AreaRepetida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_peso_area_enem_congelado.area_repetida", "A mesma área aparece mais de uma vez no grupo do quadro de pesos por área")),
        new("GrupoPesoAreaEnemCongelado.PesoNegativo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_peso_area_enem_congelado.peso_negativo", "O peso de uma área do quadro de pesos por área não pode ser negativo")),
        new("GrupoPesoAreaEnemCongelado.CorteForaDaFaixa", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_peso_area_enem_congelado.corte_fora_da_faixa", "O corte de uma área do quadro de pesos por área deve estar entre 0 e 1000")),
        new("GrupoPesoAreaEnemCongelado.SemAreas", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.grupo_peso_area_enem_congelado.sem_areas", "Cada grupo do quadro de pesos por área precisa de ao menos uma área")),
        ...
        new("RegraEliminacao.MinimoInvalido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.regra_eliminacao.minimo_invalido", "O mínimo do corte em área deve ser não negativo")),
        new("RegraEliminacao.AreaInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.regra_eliminacao.area_invalida", "A área do corte não é um código de área do ENEM bem formado")),
        ...
        new("RegraEliminacao.AreaEMinimoObrigatorios", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.regra_eliminacao.area_e_minimo_obrigatorios", "AreaCodigo e Minimo são obrigatórios para a regra ELIM-CORTE-EM-AREA")),
        ...
        // Issue #1349: as regras de contorno da janela de solicitação de isenção (UNI-REQ-0106).
        new("ProcessoSeletivo.JanelaDeIsencaoSemPrazo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.janela_de_isencao_sem_prazo", "A fase que abre a solicitação de isenção precisa de início e fim definidos")),
        new("ProcessoSeletivo.JanelaDeIsencaoNaoAbreComAInscricao", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.janela_de_isencao_nao_abre_com_a_inscricao", "A janela de solicitação de isenção abre no mesmo instante em que abrem as inscrições")),
        new("ProcessoSeletivo.JanelaDeIsencaoNaoTerminaAntesDaInscricao", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.janela_de_isencao_nao_termina_antes_da_inscricao", "A solicitação de isenção precisa terminar antes do fim das inscrições")),
        new("ProcessoSeletivo.JanelaDeIsencaoMenorQueCincoDias", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.janela_de_isencao_menor_que_cinco_dias", "A janela de solicitação de isenção precisa de ao menos cinco dias corridos")),
        ...
        new("EtapaProcesso.BancaDuplicadaNaEtapa", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.banca_duplicada_na_etapa", "O mesmo tipo de banca foi requerido duas vezes na etapa")),
        new("EtapaProcesso.JanelaInvertida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.janela_invertida", "O fim da janela da etapa é anterior ao início")),
        new("EtapaProcesso.TipoBancaNaoEncontradoOuInativo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.tipo_banca_nao_encontrado_ou_inativo", "O tipo de banca não existe ou está inativo no cadastro")),
        new("EtapaProcesso.AncoraNaoEhProdutoPreliminarDaEtapa", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.ancora_nao_eh_produto_preliminar_da_etapa", "O recurso contra ato publicado ancora num resultado preliminar da própria etapa")),
        new("EtapaProcesso.CienciaSemParecerIndividual", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.ciencia_sem_parecer_individual", "O prazo contado da ciência exige que a etapa prometa parecer individual")),
        new("EtapaProcesso.RecursoDuplicadoNaEtapa", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.recurso_duplicado_na_etapa", "Cada fato recorrível abre uma única janela de interposição")),
        new("RecursoDaEtapa.RegraCatalogoInvalida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.regra_catalogo_invalida", "A regra declarada não é uma regra de prazo de recurso do catálogo")),
        new("RecursoDaEtapa.AncoraEmAtoCongelante", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.ancora_em_ato_congelante", "A âncora do recurso da etapa não pode ser o ato que congela a configuração")),
        new("RecursoDaEtapa.AncoraEmAtoIrreversivel", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.ancora_em_ato_irreversivel", "A âncora do recurso da etapa não pode ser ato de efeito irreversível")),
        new("RecursoDaEtapa.AncoraObrigatoria", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.ancora_obrigatoria", "Declare de que instante o prazo corre: da publicação do ato ou da ciência do candidato")),
        // A janela da etapa prova as mesmas invariantes de prazo e suspensividade que a regra
        // da fase: o value object é o mesmo, e a recusa precisa nomear quem recusou. Sem estes
        // registros, a mesma configuração recusada com 422 na fase virava 500 na etapa.
        new("RecursoDaEtapa.PrazoNaoPositivo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.prazo_nao_positivo", "O prazo de interposição deve ser estritamente positivo")),
        new("RecursoDaEtapa.PrazoEmDiasCorridos", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.prazo_em_dias_corridos", "Prazo de interposição em dias corridos não é aceito")),
        new("RecursoDaEtapa.PrazoSemUnidadeDeclaravel", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.prazo_sem_unidade_declaravel", "O prazo de interposição precisa declarar dias úteis ou horas")),
        new("RecursoDaEtapa.PrazoEmFracaoDeDiaUtil", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.prazo_em_fracao_de_dia_util", "Prazo de interposição em dias úteis exige valor inteiro")),
        new("RecursoDaEtapa.SuspensividadeIncompleta", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.suspensividade_incompleta", "A suspensividade exige valor e unidade juntos, ou nenhum dos dois")),
        new("RecursoDaEtapa.SuspensividadeUnidadeNaoDeclaravel", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.suspensividade_unidade_nao_declaravel", "A unidade da suspensividade não é declarável")),
        new("RecursoDaEtapa.SuspensividadeNaoPositiva", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.recurso_da_etapa.suspensividade_nao_positiva", "O valor da suspensividade deve ser estritamente positivo")),
        new("EtapaProcesso.AtoDuplicadoNaEtapa", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.etapa_processo.ato_duplicado_na_etapa", "O mesmo tipo de ato foi declarado duas vezes na etapa")),
        new("ProcessoSeletivo.EtapaSemFaseNoCronograma", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_sem_fase_no_cronograma", "A etapa declara uma fase que não está no cronograma do processo")),
        new("ProcessoSeletivo.EtapaComecaAntesDaFase", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_comeca_antes_da_fase", "A etapa começa antes da fase que a abriga")),
        new("ProcessoSeletivo.EtapaTerminaDepoisDaFase", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_termina_depois_da_fase", "A etapa termina depois da fase que a abriga")),
        new("ProcessoSeletivo.EtapaForaDaJanelaDaFase", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_fora_da_janela_da_fase", "A etapa acontece inteira fora da janela da fase que a abriga")),
        new("ProcessoSeletivo.EtapaReferenciadaPorExigenciaDocumental", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_referenciada_por_exigencia_documental", "A etapa a remover é onde um documento exigido é coletado")),
        new("DocumentoExigido.EtapaNaoPertenceAoProcesso", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.documento_exigido.etapa_nao_pertence_ao_processo", "A etapa que coleta o documento não é uma etapa deste processo")),
        new("DocumentoExigido.EtapaNaoPertenceAFase", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.documento_exigido.etapa_nao_pertence_a_fase", "A etapa que coleta o documento não acontece na fase em que ele é exigido")),
        ...
        // A conclusão do ciclo recursal por matéria. Cada estado tem código próprio porque a
        // remediação difere: declarar a fase que conclui, remover a declaração que não cabe,
        // ou mover a concluinte para depois da fase que ela encerra.
        new("ProcessoSeletivo.ConclusaoNaoDeclarada", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.conclusao_nao_declarada", "A fase publica resultado preliminar sem a definitiva da matéria e não declara qual fase a conclui")),
        new("ProcessoSeletivo.ConclusaoDeclaradaSemPreliminar", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.conclusao_declarada_sem_preliminar", "A fase declara uma fase concluinte sem publicar resultado preliminar")),
        new("ProcessoSeletivo.ConclusaoDeclaradaEmFaseQueSeConclui", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.conclusao_declarada_em_fase_que_se_conclui", "A fase declara a si mesma como concluinte do próprio ciclo recursal")),
        new("ProcessoSeletivo.FaseConcluinteForaDoCronograma", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.fase_concluinte_fora_do_cronograma", "A fase declarada como concluinte não está no cronograma")),
        new("ProcessoSeletivo.FaseConcluinteSemResultadoDefinitivo", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.fase_concluinte_sem_resultado_definitivo", "A fase declarada como concluinte não publica nenhum resultado definitivo")),
        new("ProcessoSeletivo.FaseConcluinteAntecedeAConcluida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.fase_concluinte_antecede_a_concluida", "A fase concluinte não pode anteceder na ordem a fase que ela encerra")),
        new("ProcessoSeletivo.FaseConcluinteComecaAntesDaConcluida", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.fase_concluinte_comeca_antes_da_concluida", "A janela da fase concluinte começa antes da janela da fase que ela encerra")),
        ...
        new("FaseCronograma.AtoDuplicadoNaFase", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.fase_cronograma.ato_duplicado_na_fase", "A fase declara o mesmo tipo de ato mais de uma vez")),
        ...
        // Rascunho do bloco do ato no passo de Revisão. São só duas recusas de forma: o
        // conteúdo em si não é validado, porque rascunho de formulário pela metade é o caso
        ...
        new("ReferenciaTemporalFatos.TipoDesconhecido", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.referencia_temporal_fatos.tipo_desconhecido", "Tipo de referência temporal fora do catálogo fechado")),
