...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new("ProcessoSeletivo.EtapaNotaEnemComLancamento", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.etapa_nota_enem_com_lancamento", "Etapa de nota do ENEM não admite banca nem parecer individual")),
