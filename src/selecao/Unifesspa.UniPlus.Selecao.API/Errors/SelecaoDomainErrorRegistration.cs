...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new(MotivoDecisaoIsencaoErrorCodes.SituacaoAlteradaConcorrentemente, new DomainErrorMapping(StatusCodes.Status409Conflict, "uniplus.selecao.motivo_decisao_isencao.situacao_alterada_concorrentemente", "A situação do motivo foi alterada por outra operação", ConflitoRetentavel: true)),
        ...
        new("VersaoConfiguracao.NumeroDuplicado", new DomainErrorMapping(StatusCodes.Status409Conflict, "uniplus.selecao.versao_configuracao.numero_duplicado", "Outra publicação concorrente já criou esta versão da configuração", ConflitoRetentavel: true)),
        ...
        new("RascunhoDaPublicacao.GravacaoConcorrente", new DomainErrorMapping(StatusCodes.Status409Conflict, "uniplus.selecao.rascunho_publicacao.gravacao_concorrente", "Outra gravação do mesmo rascunho chegou primeiro", ConflitoRetentavel: true)),
