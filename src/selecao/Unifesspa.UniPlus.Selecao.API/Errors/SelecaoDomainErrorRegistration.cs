...
internal sealed class SelecaoDomainErrorRegistration : IDomainErrorRegistration
{
    ...
    [
        ...
        new("ProcessoSeletivo.JanelaDeIsencaoSemRegraDeRecurso", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.janela_de_isencao_sem_regra_de_recurso", "A fase de solicitação de isenção precisa de regra de recurso")),
        new("ProcessoSeletivo.PrazoDeRecursoDaIsencaoMenorQueDoisDiasUteis", new DomainErrorMapping(StatusCodes.Status422UnprocessableEntity, "uniplus.selecao.processo_seletivo.prazo_de_recurso_da_isencao_menor_que_dois_dias_uteis", "O recurso contra o indeferimento da isenção exige prazo de ao menos dois dias úteis")),
