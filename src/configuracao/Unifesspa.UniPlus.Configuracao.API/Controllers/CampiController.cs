...
/// <summary>
/// Endpoints públicos de leitura (<c>GET /api/configuracao/campi</c>,
/// <c>GET /api/configuracao/campi/{id}</c>) e endpoints admin
/// (<c>POST/PUT/DELETE /api/configuracao/admin/campi</c>) restritos a
