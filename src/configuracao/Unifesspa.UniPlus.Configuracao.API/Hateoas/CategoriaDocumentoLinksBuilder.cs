...
[SuppressMessage(
    ...
    Justification = "Instanciada via IServiceProvider.AddSingleton<IResourceLinksBuilder<CategoriaDocumentoDto>, CategoriaDocumentoLinksBuilder>().")]
internal sealed class CategoriaDocumentoLinksBuilder : IResourceLinksBuilder<CategoriaDocumentoDto>
{
    private readonly LinkGenerator _linkGenerator;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public CategoriaDocumentoLinksBuilder(LinkGenerator linkGenerator, IHttpContextAccessor httpContextAccessor)
    {
    ...
    public IReadOnlyDictionary<string, string> Build(CategoriaDocumentoDto dto)
    {
        ArgumentNullException.ThrowIfNull(dto);

        HttpContext? httpContext = _httpContextAccessor.HttpContext;
        const string controllerName = "CategoriasDocumento";
