...
/// <see cref="TermoConsentimentoDto"/> (termo completo, endpoint
/// <c>ObterPorId</c>). Relações em V1: <c>self</c> e <c>collection</c>.
/// </summary>
[SuppressMessage(
    "Performance",
    "CA1812:Avoid uninstantiated internal classes",
    Justification = "Instanciada via IServiceProvider.AddSingleton<IResourceLinksBuilder<TermoConsentimentoDto>, TermoConsentimentoLinksBuilder>().")]
internal sealed class TermoConsentimentoLinksBuilder : IResourceLinksBuilder<TermoConsentimentoDto>
{
    private readonly LinkGenerator _linkGenerator;
    private readonly IHttpContextAccessor _httpContextAccessor;

    public TermoConsentimentoLinksBuilder(LinkGenerator linkGenerator, IHttpContextAccessor httpContextAccessor)
    {
    ...
    public IReadOnlyDictionary<string, string> Build(TermoConsentimentoDto dto)
    {
