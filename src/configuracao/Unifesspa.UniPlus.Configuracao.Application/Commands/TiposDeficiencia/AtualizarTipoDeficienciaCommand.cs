...
/// <summary>
/// Atualiza um tipo de deficiência existente. <c>Codigo</c> e <c>Nome</c> são
/// editáveis, cada um com nova checagem de unicidade entre vivos; a descrição
/// (obrigatória, ADR-0116) e a classificação de permanência também podem ser
/// editadas. O <c>Id</c> é imutável. O ator (<c>updated_by</c>) é carimbado
