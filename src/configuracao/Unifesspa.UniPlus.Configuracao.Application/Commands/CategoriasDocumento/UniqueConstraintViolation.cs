...
/// categoria de documento — <c>ix_categoria_documento_codigo_vivo</c> — para o
...
/// </summary>
/// <remarks>
/// A tabela tem um único índice único, então <see cref="IsCodigoConflict"/> basta
/// para discriminar: qualquer outra constraint devolve <see langword="false"/> e a
/// exceção segue propagando, em vez de virar um 409 que aponta o campo errado.
/// </remarks>
internal static class UniqueConstraintViolation
{
    private const string UniqueViolationSqlState = "23505";

    private const string CodigoConstraint = "ix_categoria_documento_codigo_vivo";
    ...
    /// que garante uma única categoria viva por código.
    /// </summary>
