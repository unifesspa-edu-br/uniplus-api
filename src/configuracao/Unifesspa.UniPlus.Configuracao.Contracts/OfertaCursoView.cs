...
/// <param name="GrupoAreaEnem">Grupo de área do ENEM do curso da oferta, com código e rótulo, ou null quando o curso não o declara.</param>
public sealed record OfertaCursoView(
    ...
    GrupoAreaEnemView? GrupoAreaEnem);
