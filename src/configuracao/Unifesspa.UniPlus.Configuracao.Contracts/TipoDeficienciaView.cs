...
/// (id + código + nome + descrição + classificação de permanência) que outros
/// bounded contexts leem antes de congelar por valor a identidade (snapshot-copy,
/// ADR-0061).
/// </summary>
/// <param name="Id">Identificador único (Guid v7 — ADR-0032).</param>
/// <param name="Codigo">
/// Código classificatório do tipo (ex.: <c>DEFICIENCIA_VISUAL</c>) — identidade
/// semântica que os fatos de atendimento congelam junto com a origem
/// (UNI-REQ-0061).
/// </param>
/// <param name="Nome">Rótulo legível do tipo de deficiência.</param>
