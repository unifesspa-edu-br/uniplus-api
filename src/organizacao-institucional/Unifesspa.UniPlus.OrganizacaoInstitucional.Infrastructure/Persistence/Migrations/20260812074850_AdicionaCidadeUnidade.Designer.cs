...
namespace Unifesspa.UniPlus.OrganizacaoInstitucional.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260812074850_AdicionaCidadeUnidade")]
    partial class AdicionaCidadeUnidade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Unifesspa.UniPlus.OrganizacaoInstitucional.Domain.Entities.Unidade", b =>
                {
                    ...
                    b.ToTable("unidade", "organizacao", t =>
                        {
                            t.HasCheckConstraint("ck_unidade_cidade_completa", "(cidade_codigo_ibge IS NULL AND cidade_nome IS NULL AND cidade_uf IS NULL) OR (cidade_codigo_ibge IS NOT NULL AND cidade_nome IS NOT NULL AND cidade_uf IS NOT NULL)");
                        });
                });
