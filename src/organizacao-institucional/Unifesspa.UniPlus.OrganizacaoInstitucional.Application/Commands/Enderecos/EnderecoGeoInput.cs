...
/// presente, exige CEP + cidade (validados por <c>ReferenciaEnderecoGeo</c>). O
/// <c>displayAtualizadoEm</c> não viaja — é carimbado server-side pelo handler.
/// Mantido byte-equivalente à cópia do módulo Configuração (ADR-0035).
/// </summary>
