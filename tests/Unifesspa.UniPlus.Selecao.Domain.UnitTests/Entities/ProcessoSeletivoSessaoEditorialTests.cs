...
public sealed class ProcessoSeletivoSessaoEditorialTests
{
    ...
    public void Definir_ForaDeEstadoEditavel_Recusa(StatusProcesso status)
    {
        ...
        Result resultado = processo.DefinirEtapas(
            [EtapaProcesso.Criar("Nova etapa", CaraterEtapa.Classificatoria, TipoEtapaSnapshot.Criar(Guid.CreateVersion7(), "PROVA_OBJETIVA", "Prova Objetiva").Value!, peso: 2m, ordem: 1).Value!],
    ...
    public void Definir_Recusado_NaoIncrementaRevisao()
    {
        ...
        Result resultado = processo.DefinirEtapas(
            [
                EtapaProcesso.Criar("Prova A", CaraterEtapa.Classificatoria, TipoEtapaSnapshot.Criar(Guid.CreateVersion7(), "PROVA_OBJETIVA", "Prova Objetiva").Value!, peso: 1m, ordem: 1).Value!,
                EtapaProcesso.Criar("Prova B", CaraterEtapa.Classificatoria, TipoEtapaSnapshot.Criar(Guid.CreateVersion7(), "PROVA_OBJETIVA", "Prova Objetiva").Value!, peso: 1m, ordem: 1).Value!,
            ],
