...
public sealed class ProcessoSeletivoPublicarTests
{
    ...
    public void DefinirX_ProcessoPublicado_RecusaMutacao(string dimensao)
    {
        ...
        {
            "etapas" => processo.DefinirEtapas([EtapaProcesso.Criar("Nova Etapa", CaraterEtapa.Classificatoria, TipoEtapaSnapshot.Criar(Guid.CreateVersion7(), "PROVA_OBJETIVA", "Prova Objetiva", admitePontuacao: true, admiteEliminacao: true).Value!, peso: 1m, ordem: 1).Value!], PrecondicaoIfMatch.Ausente),
