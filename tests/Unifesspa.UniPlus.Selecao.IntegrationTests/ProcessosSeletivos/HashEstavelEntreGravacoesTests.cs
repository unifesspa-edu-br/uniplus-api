    ...
    private static ProcessoSeletivo ProcessoBase()
    {
        ...
        processo.DefinirEtapas([
            EtapaProcesso.Criar(
                ...
                TipoEtapaSnapshot.Criar(TipoEtapaOrigem, "PROVA_OBJETIVA", "Prova Objetiva", admitePontuacao: true, admiteEliminacao: true, notaDeOrigemNoEnem: false).Value!,
        ...
        processo.DefinirClassificacao(ConfiguracaoClassificacao.Criar(
            ...
            1, [], baseadoEmEnem: false, resolucaoPesoAreaEnem: null, quadroPesoAreaEnem: []).Value!, PrecondicaoIfMatch.Ausente).IsSuccess.Should().BeTrue();
