...
public sealed class CatalogoPermissoesGeradorTests
{
    ...
    public void Gerar_FonteVersionada_ReproduzArtefatoVersionado()
    {
        ...
        // Mesma normalização do --verify em Program.cs: um checkout com
        // core.autocrlf=true converteria o artefato versionado para CRLF,
        // enquanto GerarDeArquivo sempre retorna LF.
        gerado.Should().Be(File.ReadAllText(artefato).ReplaceLineEndings("\n"));
    }
