...
public sealed class IngressoApiFactory : WebApplicationFactory<Program>
#pragma warning restore CA1515
{
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, configurationBuilder) =>
        {
            ...
            [
                new KeyValuePair<string, string?>("ConnectionStrings:IngressoDb", "Host=localhost;Port=5432;Database=uniplus_tests;Username=uniplus;Password=uniplus_dev"),
